    ...
    <div className="grid md:grid-cols-[360px_1fr] w-full pt-[76px] md:px-20 max-w-[1080px] text-center md:text-left mx-auto">
        <div  className="text-white font-normal">
             ...
             <div className="text-white text-shadow-lg/30 text-3xl md:text-5xl font-bold" >
                ...
                <div className="grid w-full py-10 text-[16px] leading-tight px-4 max-w-[1080px] text-center md:text-left mx-auto text-white">
        ...
        <div className="relative">
                <div className="absolute inset-0 md:flex md:bg-[url('/image-james.jpg')] bg-center bg-cover h-100 justify-center items-center  md:ml-40">
